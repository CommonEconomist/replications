...
# Indicator for war years
x$war<-ifelse(x$year>=1914 & x$year<=1919 |
                x$year>=1939 & x$year<=1947,1,0)
...
# Plot results : trends are similar, shift in magnitude
par(bty='n',las=1)
...
trapz(prc@x.values[[1]][-1],prc@y.values[[1]][-1]) # 0.12 
